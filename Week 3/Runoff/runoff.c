...
// preferences[i][j] is the index of the candidate who is the j-th preference for voter i
...
// Print winner if someone has majority
bool print_winner(void)
{
    for (int i = 0; i < candidate_count; i++)
    {
...
// Return minimum votes among remaining candidates
int find_min(void)
{
...
// Check if tie among remaining candidates
bool is_tie(int min)
{
    for (int i = 0; i < candidate_count; i++)
    {
